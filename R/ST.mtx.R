...
#'
#' @param infile Path to the SpaceRnager output directory and the project name
...
ST.mtx <- function(path # The Spaceranger output directory which includes filtered_feature_bc_matrix and spatial folders
  ...
  x1@images$x1 <- Read10X_Image(paste0(dir1,"spatial/"),filter.matrix = T) # Adding the image to the Seurat object
